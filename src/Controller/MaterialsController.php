...
class MaterialsController extends AbstractController
{
    ...
    public function addmaterials(Request $request, $id, SessionInterface $session): Response
    {
        ...
        return $this->render('materials/addmaterials.html.twig', ['f' => $form->createView(), 'username' => $username]);
    }
    ...
    public function editmaterials(Request $request, int $id, SessionInterface $session): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($ancienQuantity > $quantity) {
                $diff = $ancienQuantity - $quantity;
                $quantityAdded = $AvailableQuantity - $diff;
            } else if ($ancienQuantity < $quantity) {
                $diff = $quantity - $ancienQuantity;
                $quantityAdded = $AvailableQuantity + $diff;
            } else {
                $quantityAdded = $AvailableQuantity;
            }
        ...
        return $this->render('materials/editmaterials.html.twig', ['f' => $form->createView(), 'username' => $username]);
    }
